...
public class FusekiService {
    ...
    public void sacuvajAgencijuURDF(Agencija a) {
        String query = MY_PREFIX + RDF_PREFIX +
                "INSERT DATA { :" + a.getId() + " rdf:type :AgencijaZaZaposljavanje ; :imaNaziv \""
                + a.getNazivAgencije() + "\" . }";
        izvrsiUpdate(query);
    }
    ...
    public void sacuvajOglasURDF(Oglas o) {
        ...
        triples.append(":").append(o.getId()).append(" rdf:type :Oglas ; :imaNaziv \"").append(o.getNaslov())
                .append("\" . \n");
